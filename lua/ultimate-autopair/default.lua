...
M.conf={
    ...
    internal_pairs={-- *ultimate-autopair-pairs-default-pairs*
        ...
        {'(',')',fly=true,dosuround=true,newline=true,space=true,fastwarp=true},
        {'{','}',fly=true,dosuround=true,newline=true,space=true,fastwarp=true},
        {'"','"',suround=true,string=true,fastwarp=true,multiline=false,alpha={'txt'}},
        {"'","'",suround=true,cond=function(fn) return not fn.in_lisp() or fn.in_string() end,alpha=true,nft={'tex'},string=true,fastwarp=true,multiline=false},
